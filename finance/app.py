...
def register():
    ...
    if request.method == "POST":
        if not request.form.get("username"):
            ...
            return apology("this user exist")
        elif not request.form.get("password"):
            return apology("must provide password")
        elif not request.form.get("confirmation"):
            return apology("repit the password")
        else:
...
def sell():
    ...
    if request.method == "POST":
        ...
        symbols_dict = {d['symbol']: d['sum_of_shares'] for d in summaries}
        ...
        return render_template("sell.html", symbols=summaries)
